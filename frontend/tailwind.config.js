...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        bg_gradient: 'linear-gradient(81.68deg,#5ca139 18.74%,#bdcf99 83.58%,#d7e9a6 99.67%)',
        primary_gradient: 'linear-gradient(118deg, #54b862, rgba(84, 184, 98, 0.7))',
      ...
      boxShadow: {
        ...
        dropdown: '0 0.313rem 0.8rem rgba(122,123,151,.5), 0 0.126rem 0.225rem rgba(122,123,151,.3)',
