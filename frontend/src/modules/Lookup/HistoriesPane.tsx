...
function HistoriesPane({ isActive, diaries, producerName }: IHistoriesPane) {
  return (
    <div className={`${isActive ? 'block' : 'hidden'} font-landing`}>
      <div className="p-2 border-b border-slate-100">
        ...
        <p className="text-[16px] text-icon2">
          Thông tin được <b className="text-icon">{producerName}</b> ghi nhật ký trong quá trình sản xuất
        </p>
      </div>
